...
class Signature:
    ...
    def build_method_signatures(methods) -> list:
        ...
        for method in methods:
            ...
            possible_method_signatures = Signature._get_all_combinations(method_signature)

            # {
            #   class: 'S3',
            #   method: <object pointer> ,
            #   signature: Signature(),
    ...
    def _get_all_combinations(signature):
        ...
        for param in signature.parameters.values():
            if param.default == inspect.Parameter.empty or param.kind not in (inspect.Parameter.VAR_KEYWORD,
